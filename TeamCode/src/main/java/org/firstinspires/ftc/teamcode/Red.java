            ...
            if (targetVisible) {
                ...
                if(skystoneTarget){
                    ...
                    if(change == 0){
                        ...
                        sleep(500);
                        BRZ.setPower(0);
                        mecanum.move(0.812,Math.PI/2,0);
                        sleep(400);
                        mecanum.stop();
                        mecanum.move(.3,0,0);
                        sleep(550);
                        ...
                        sleep(400);
                        withoutEncoders();
                        mecanum.move(0.5,3*Math.PI/2,0);
                        JL_DRC.setPosition(0);
                        JL_IZQ.setPosition(1);
                        sleep(600);
                        CUBO.setPosition(0);
                        ...
                        mecanum.move(1,Math.PI/2,0);
                        sleep(75);
                        mecanum.move(0.25,3 * Math.PI/2,0);
                        change=1;
                    } else if(change == 1){
