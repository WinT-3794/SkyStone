...
public class ParallelAutonomous extends LinearOpMode {
            ...
            switch (threads){
                case 1:
                    try {
                        ...
                        telemetry.addData("Thread A", "Got failure: " + err);
                    }
                    break;
                case 2:
                    try {
                    ...
                    try {
                        ...
                        telemetry.addData("Thread B", "Got failure: " + err);
                    }
                    break;
            }
    ...
    public void runner(){
        //Write here in your Child Auto your runner.
    }

    public void instance(){
        //Write here ins your child auto your thread instances.
    }

    public void delay(Thread thread, long milis){
        try {
            thread.sleep(milis);
        } catch (InterruptedException err) {
            telemetry.addData(thread.getName(), "Failure in sleep: " + err);
        }
    }
}
